...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'base_userprofile', 'about_me',
                      self.gf('django.db.models.fields.CharField')(default='Something about me...', max_length=2000),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.about_me'
        db.delete_column(u'base_userprofile', 'about_me')
    ...
    models = {
        ...
        u'base.userprofile': {
            ...
            'about_me': ('django.db.models.fields.CharField', [], {'default': "'Something about me...'", 'max_length': '2000'}),
            'contact_phone': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
